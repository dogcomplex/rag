...
OUTDIR = pathlib.Path('.knowledge/indexes/attributes/pii-scan'); OUTDIR.mkdir(parents=True, exist_ok=True)
...
for line in sys.stdin:
    ...
    (OUTDIR / f"{job['doc_id']}.json").write_text(json.dumps({
        "doc_id": job['doc_id'], "attribute": "pii-scan", "value": findings, "risk": risk, "confidence": 0.6
